 ...
 * File: plugins/NickPlugin/nicks.yml
 * Author: Muvixo
 */
public class NickStorage {
    ...
    public String getNickname(UUID uuid) {
        return config.getString(uuid.toString() + ".nick");
    }

    public void setNickname(UUID uuid, String nickname) {
        config.set(uuid.toString() + ".nick", nickname);
        save();
    }

    public void clearNickname(UUID uuid) {
        config.set(uuid.toString() + ".nick", null);
        save();
    }

    public boolean hasNickname(UUID uuid) {
        return config.contains(uuid.toString() + ".nick");
    }

    public String getNickRank(UUID uuid) {
        return config.getString(uuid.toString() + ".rank");
    }

    public void setNickRank(UUID uuid, String rank) {
        config.set(uuid.toString() + ".rank", rank);
        save();
    }

    public void clearNickRank(UUID uuid) {
        config.set(uuid.toString() + ".rank", null);
        save();
    }
